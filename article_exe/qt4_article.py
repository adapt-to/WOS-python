...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "文献保存地址：", None))
        self.label_3.setText(_translate("Form", "下载文献数：", None))
        self.label_2.setText(_translate("Form", "文献下载网址：", None))
        ...
        self.label_5.setText(_translate("Form", "                                                                 谨作学习之用/made by HYF", None))
